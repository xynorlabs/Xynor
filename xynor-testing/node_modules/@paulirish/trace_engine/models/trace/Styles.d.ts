...
export declare class TimelineCategory {
    ...
    visible: boolean;
    constructor(name: EventCategory, title: {i18nId: string, values: Record<string, string|number>, formattedDefault: string}, visible: boolean, cssVariable: `--app-color-${string}`);
    get hidden(): boolean;
